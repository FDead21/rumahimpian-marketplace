...
<body class="bg-gray-50 flex flex-col min-h-screen">
    ...
    <div class="bg-sky-900 text-white">
        <div class="max-w-4xl mx-auto px-4 py-16 text-center">
            ...
            @if($agent->agency)
                <a href="{{ route('property.agency.show', $agent->agency->slug) }}" class="inline-block bg-sky-800 hover:bg-sky-700 px-4 py-1 rounded-full text-sm font-medium transition mb-4">
                    🏢 {{ $agent->agency->name }}
                </a>
            @else
