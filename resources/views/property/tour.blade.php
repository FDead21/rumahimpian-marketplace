...
<body class="bg-black overflow-hidden relative">
    ...
    <div class="control-box">
        <div class="flex items-center gap-2">
            ...
            <span class="text-sm">Drag to look around</span>
        </div>
        <div class="h-4 w-px bg-gray-500"></div>
        <div class="flex items-center gap-2">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7"></path></svg>
            <span class="text-sm">Scroll to zoom</span>
        </div>
    </div>
    ...
    <script>
        @if($tourImage)
            pannellum.viewer('panorama', {
                ...
                "autoLoad": true,
                "autoRotate": -2, // Slowly rotate automatically
                "compass": true,
                "showControls": true
            });
        @else
            // Fallback if no image found (Shouldn't happen due to controller logic)
            alert("No 360 image found for this property.");
        @endif
    </script>
</body>
</html>