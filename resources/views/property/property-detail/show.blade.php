                ...
                <div class="bg-white p-6 rounded-xl shadow-lg border sticky top-4">
                    ...
                    <div class="mt-6 border-t pt-4">
                        ...
                        <form action="{{ route('property.inquiry.store', $property->id) }}" method="POST" class="space-y-4">
                            {{-- CRITICAL: You must have this token --}}
                            @csrf 
                            ...
                            <div>
                                ...
                                <textarea name="message" rows="4" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-500 focus:ring-sky-500">{{ old('message', 'I am interested in this property.') }}</textarea>
                            </div>
