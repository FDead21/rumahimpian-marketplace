<x-eo-layout>
    ...
    <div class="bg-gradient-to-br from-rose-600 to-pink-700 text-white py-16 text-center">
        <h1 class="text-4xl font-extrabold mb-2">Our Event Packages</h1>
        <p class="text-rose-200 text-lg">Everything you need for a perfect event, bundled together</p>
    </div>

    <div class="max-w-7xl mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @forelse($packages as $package)
            <div class="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 relative flex flex-col">
            ...
            @empty
                <div class="col-span-3 text-center py-16 text-gray-400">
                    ...
                    <p class="text-lg font-semibold">No packages available yet.</p>
                </div>
            @endforelse
        </div>
    </div>
